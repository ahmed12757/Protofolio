        ...
        <table className="w-full border-separate border-spacing-0 text-xs">
          <tbody>
            {experience.map((item, idx) => (
              <tr key={idx}>
                <td className="py-4 pr-4 text-white/60 text-left align-top w-[40%] border-b border-white/10 h-[70px]">
                  {item.role}
                </td>
                <td
                  className={`py-4 pr-4 text-white/60 ${
                    updateTextPosition ? "text-center" : "text-left"
                  } align-top w-[30%] border-b border-white/10 h-[70px]`}
                >
                  {item.company}
                </td>
                <td className="py-4 text-white/60 text-right align-top w-[30%] border-b border-white/10 h-[70px]">
                  {item.duration}
                </td>
              </tr>
            ))}
